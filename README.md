...
| `HOMEWORK_DEFENSE_REPORT_RU.md` | Развернутый текст защиты от первого лица, включая связь с проектом `СРМ мечты`. |
...
Ниже лежат реальные скриншоты публичной упаковки проекта в `GitHub`.

### Главная страница репозитория

![Главная страница репозитория](screenshots/01_repo_home.png)

### README проекта

![README проекта](screenshots/02_readme_overview.png)

### Просмотр README как файла в репозитории

![Просмотр README как файла](screenshots/03_readme_file_view.png)
